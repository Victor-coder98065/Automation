...
public class DealXBase {

	// This is to setup and select the intended browser to be used during the Tests.
		...
		public static WebDriver OpenBrowser() {
			...
			try {
				if (sBrowserName.equalsIgnoreCase("Chrome")) {
					...
					prefs.put("download.default_directory", System.getProperty("user.dir") + "\\DealXData\\Downloads");
				...
				DealXExceptionHandle.HandleException(e, "Unable to initialise browser " + sBrowserName);
			}
			return driver;
		}
		...
		public static WebDriver tearDown() {
			...
			try {
				...
				DealXExceptionHandle.HandleException(e, "Unable to quit browser successful");
			}
			return driver;
		}
}
